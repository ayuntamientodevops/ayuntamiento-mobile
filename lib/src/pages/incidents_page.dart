...
class IncidentsPage extends StatefulWidget {
  static final routeName = '/incidencias';
...
class _IncidentsPageState extends State<IncidentsPage> {
  ...
  */
        ...
        onPressed: canPressRegisterBtn
            ? () async {
                ...
                Map<String, dynamic> data = {
                  ...
                  "UserRequested": auth.getUserLogged().id,
                ...
                for (File image in images) {
                  String imageName = auth.getUserLogged().id.toString() +
                      '-$i' +
                      DateTime.now().toIso8601String();
                  TaskSnapshot addImg = await ref
                      .child("images/" +
                          auth.getUserLogged().id.toString() +
                          "/$imageName")
                      .putFile(image);
  ...
  /*
    Crea el Widget para cargar las envidencias ya se desde la camara o la galeria de fotos
   */
 ...
 */
  ...
  /*
    Define el header del formalario
   */
